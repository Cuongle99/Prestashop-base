                ...
                {if !empty($category.cover.large.url)}
                    <div class="category-cover">
                        <picture>
                            ...
                            <img class="img-fluid" src="{$category.cover.large.url}" alt="{if !empty($category.cover.legend)}{$category.cover.legend}{else}{$category.name}{/if}" fetchpriority="high" width="{$category.cover.large.width}" height="{$category.cover.large.height}">
                        </picture>
                    </div>
                {/if}
                {/if}
