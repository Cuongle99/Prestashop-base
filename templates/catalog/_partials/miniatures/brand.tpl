...
{block name='brand_miniature_item'}
  <li class="brand">
    <div class="brand-img col-xl-3 col-lg-3 col-xs-12">
    <a href="{$brand.url}">
        <picture>
    ...
    <div class="brand-products">
      <a href="{$brand.url}">
        ...
        {/if}
      </a>      <a href="{$brand.url}" class="btn btn-outline float-md-right text-xs-center">{l s='View products' d='Shop.Theme.Actions'}</a>
    </div>
  </li>
{/block}
