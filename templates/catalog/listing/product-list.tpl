...
{block name='content'}
  <section id="main"{if isset($profile_params.c_config) && isset($profile_params.c_config.class)}class="{$profile_params.c_config.class}"{/if}>
    ...
    {/if}
    {if $page.page_name != 'category' || ($page.page_name == 'category' && isset($profile_params.c_config) && $profile_params.c_config.filter_position != 2)
    || (!$listing.rendered_facets && $profile_params.c_config.filter_position == 2)}
    <section id="products">
